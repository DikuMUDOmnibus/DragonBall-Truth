...
#define GET_PC_ATTACKS(ch)	((ch)->player_specials->saved.pc_attacks)
#define GET_TPEARN(ch)      ((ch)->player_specials->saved.tpearn)
#define GET_LOGINC(ch)      ((ch)->player_specials->saved.loginc)
#define GET_RAGET(ch)      ((ch)->player_specials->saved.trage)
#define GET_LUSTT(ch)      ((ch)->player_specials->saved.lustt)
#define GET_DTIMER(ch)      ((ch)->player_specials->saved.dtimer)
#define GET_FISHT(ch)      ((ch)->player_specials->saved.fishing)
#define GET_PTIMER(ch)      ((ch)->player_specials->saved.ptimer)
#define GET_EXC(ch)      ((ch)->player_specials->saved.excp)
...
#define CLN_FLAGS(ch) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.truec))
#define AFF_FLAGS(ch) ((ch)->char_specials.saved.affected_by)
#define ROOM_FLAGS(loc) (world[(loc)].room_flags)
#define CAP_FLAGS(ch) ((ch)->char_specials.saved.act)
...
#define CLN_FLAGGED(ch, flag) (IS_SET(CLN_FLAGS(ch), (flag)))
...
#define CAP_FLAGGED(ch, flag) (!IS_NPC(ch) && IS_SET(CAP_FLAGS(ch), (flag)))
...
#define CLN_TOG_CHK(ch,flag) ((TOGGLE_BIT(CLN_FLAGS(ch), (flag))) & (flag))
...
#define GET_EYE(ch)	((ch)->player.eye)
#define GET_HAIRC(ch)	((ch)->player.hairc)
#define GET_HAIRL(ch)	((ch)->player.hairl)
#define GET_AURA(ch)    ((ch)->player.aura)
#define GET_CLAN(ch)    ((ch)->player.clan)
#define GET_BUILD(ch)   ((ch)->player.build)
#define GET_GOD(ch)     ((ch)->player.god)
#define GET_REINC(ch)   ((ch)->player.god)
...
#define GET_RAGE(ch)    ((ch)->aff_abils.rage)
#define GET_UBS(ch)     ((ch)->aff_abils.ubs)
#define GET_LBS(ch)     ((ch)->aff_abils.lbs)
...
#define LIGHT_OK(sub)	(!AFF_FLAGGED(sub, AFF_SOLAR_FLARE) && \
   (IS_LIGHT((sub)->in_room) || AFF_FLAGGED((sub), AFF_INFRAVISION)))

#define INVIS_OK(sub, obj) \
 ((!AFF_FLAGGED((obj),AFF_INVISIBLE) || AFF_FLAGGED(sub,AFF_DETECT_INVISIBILTY)) && \
...
#define INVIS_OK_OBJ(sub, obj) \
  (!IS_OBJ_STAT((obj), ITEM_INVISIBLE) || AFF_FLAGGED((sub), AFF_DETECT_INVISIBILTY))
...
#define CLASS_ABBR2(ch) (IS_NPC(ch) ? "--" :class_abbrevs2[(int)GET_CLASS(ch)])

#define CLASS_ABBR(ch) (IS_NPC(ch) ? "--" : class_abbrevs[(int)GET_CLASS(ch)])

#define IS_Human(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_Human))
#define IS_Namek(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_Namek))
#define IS_icer(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_icer))
#define IS_saiyan(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_saiyan))
#define IS_MAJIN(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_MAJIN))
#define IS_ANDROID(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_ANDROID))				
#define IS_KAI(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_KAI))
#define IS_HALF_BREED(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_HALF_BREED))	
#define IS_BIODROID(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_BIODROID))
#define IS_KONATSU(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_KONATSU))
#define IS_CHANGELING(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_CHANGELING))
#define IS_demon(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_demon))
#define IS_TRUFFLE(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_TRUFFLE))
#define IS_MUTANT(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_MUTANT))
#define IS_KANASSAN(ch)	(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_KANASSAN))
#define IS_ANGEL(ch)    (!IS_NPC(ch) && \
                                (GET_CLASS(ch) == CLASS_ANGEL))
