 ...
 * NO, then players will not be allowed to kill, summon, MAJIN, or sleep
...
/* exp change limits */
int max_exp_gain = 500000000;	/* max gainable per kill */
int max_exp_loss = 500000;	/* max losable per death */

/* number of tics (usually 75 seconds) before PC/NPC corpses decompose */
int max_npc_corpse_time = 2;
int max_pc_corpse_time = 1;

/* How many ticks before a player is sent to the void or idle-rented. */
int idle_void = 8;
int idle_rent_time = 10;

/* This level and up is immune to idling, LVL_IMPL+1 will disable it. */
int idle_max_level = LVL_IMMORT;

/* How many seconds (standard) before a timed reboot is performed? */
int reboot_time = 172800;

/* Has a zreset * been done recently? */
int reseted = FALSE;
/* What state do we want timed reboots to initiate in?  i.e. Go down
  * within reboot_time straight off the bat, or wait for a god to type
  * shutdown timed? (Set to 0 for 'shutdown timed') */
 int reboot_state = 1;

int interest_time = 28800;

int interest_state = 1;
int transport_state;
...
/* "okay" etc. */
const char *OK = "Okay.\r\n";
const char *NOPERSON = "&09WHO!? &15That person isn't here!.&00\r\n";
const char *NOEFFECT = "\r\n";
...
sh_int trans_space = 4200;
sh_int trans_earth = 5399;
sh_int trans_frigid = 2117;
sh_int trans_konack = 743;
sh_int trans_vegeta = 8087;
sh_int trans_namek = 10000;
sh_int trans_orainas = 17138;
sh_int mortal_start_room  = 1380;
sh_int hell_room = 20000;
sh_int saiyan_start_room = 8085;
sh_int angel_start_room = 17000;
sh_int icer_start_room = 2100;
sh_int namek_start_room = 10038;
sh_int truffle_start_room = 11052;
sh_int demon_start_room = 12835;
sh_int majin_start_room = 14000;
sh_int pk1_room = 6609;
sh_int pk2_room = 6605;
sh_int pk3_room = 6613;
sh_int pk4_room = 6617;
sh_int konack_start_room = 4250;
...
sh_int frozen_start_room = 1202;
 ...
 sh_int death_start_room = 4705;

 sh_int ctf_start_room = 8099;
...
const char *MENU =
"\r\n"
"   &16[&090&16] &15Exit &11Drag&12(&09*&12)&11n Ball &15- &16Resurrection of &12T&00&07r&00&06u&00t&12h&10! &00\r\n"
"   &16[&091&16] &15Enter &11Drag&12(&09*&12)&11n Ball &15- &16Resurrection of &12T&00&07r&00&06u&00t&12h&10! &00\r\n"
"   &16[&092&16] &16Enter description &00\r\n" 
"   &16[&093&16] &16Read background story &00\r\n"
"   &16[&094&16] &16Delete this character &00\r\n"
"   &09Pick one: &00\r\n";


const char *WELC_MESSG =
"\r\n"
"Welcome to &11Drag&12(&09*&12)&11n Ball &15- &16Resurrection of &12T&00&07r&00&06u&00&07t&12h&10!&00"
"\r\n\r\n";

const char *START_MESSG ="&00&07W&14e&00&06l&16c&00&06o&14m&00&07e&15. This is your new &11Drag&12(&09*&12)&11n Ball &15- &16Resurrection of &12T&00&07r&00&06u&00&07t&12h&15 character!  You can now earn gold, gain experience, find weapons and equipment, and much  more -- while meeting people from around the world! Don't forget to check out help newbie, help help, and help mudrules!&00\r\n";
...
long long min_wizlist_lev = 1000000;
