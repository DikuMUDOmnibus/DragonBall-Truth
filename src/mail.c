...
char *read_delete(long recipient)
{
  ...
  *(tmstr + strlen(tmstr) - 1) = '\0';
  ...
  sprintf(buf, " &16======&15[&11Drag&12(&09*&12)&11nball &12T&00&07r&00&06u&00&07t&12h &10M&00&02a&00&06i&14l &00&06S&14y&00&06s&14t&00&06e&14m&15]&16======\r\n"
	  "&11Date&16:&15 %s\r\n"
	  "&11To&16  :&15 %s\r\n"
	  "&11From&16: &15%s&00&07\r\n\r\n", tmstr, to ? to : "Unknown",
	  from ? from : "Unknown");
			  ...
			  int cmd, char *arg)
{
  ...
  if (has_mail(GET_IDNUM(ch)))
    sprintf(buf, "&11$n &15tells you, '&14You have mail waiting.&15'&00");
  else
    sprintf(buf, "&11$n &15tells you&15, &15'&14Sorry, you don't have any mail waiting.&15'&00");
  act(buf, FALSE, mailman, 0, ch, TO_VICT);
}
			  ...
			  int cmd, char *arg)
{
  ...
  if (!has_mail(GET_IDNUM(ch))) {
    sprintf(buf, "&11$n &15tells you, '&14Sorry, you don't have any mail waiting.&15'&00");
    act(buf, FALSE, mailman, 0, ch, TO_VICT);
    return;
  }
