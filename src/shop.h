...
struct shop_data {
   ...
   int	 bitvector;		/* Can attack? Use bank? focus here?	*/
...
#define TRADE_NOHuman	        8
#define TRADE_NONamek		16
#define TRADE_NOicer		32
#define TRADE_NOsaiyan		64
#define TRADE_NOMAJIN	        128
#define TRADE_NOANDROID	        256
#define TRADE_NOKAI	        512
#define TRADE_NOHALF_BREED      1024
#define TRADE_NOARLIEN          2048
#define TRADE_NOKONATSU         4096
#define TRADE_NOCHANGELING      8192
#define TRADE_NOdemon            16384
#define TRADE_NOTRUFLE          32768      
#define TRADE_NOMUTANT           65536
#define TRADE_NOTUGUIL          131072
...
#define NOTRADE_Namek(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NONamek))
#define NOTRADE_icer(i)	        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOicer))
#define NOTRADE_MAJIN(i)        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOMAJIN))
#define NOTRADE_ANDROID(i)      (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOANDROID))
#define NOTRADE_KAI(i)        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_KAI))
#define NOTRADE_HALF_BREED(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOHALF_BREED))
#define NOTRADE_ARLIAN(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOARLIAN))
#define NOTRADE_KONATSU(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOKONATSU))
#define NOTRADE_CHANGELING(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOCHANGELING))
#define NOTRADE_demon(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOdemon))
#define NOTRADE_TRUFFLE(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOTRUFFLE))
#define NOTRADE_MUTANT(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOMUTANT))
#define NOTRADE_TUGUIL(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOTUGUIL))
#define NOTRADE_saiyan(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOsaiyan))
...
#define MSG_NO_USED_SCOUTERSTAFF	"I don't buy used up scouters or other elctronics!"
