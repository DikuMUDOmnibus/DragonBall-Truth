...
void zedit_disp_arg1(struct descriptor_data *d)
{
  ...
  default:
    ...
    mudlog("SYSERR: OLC: zedit_disp_arg1(): Help!", BRF, LVL_IMMORT, TRUE);
    send_to_char("Oops...\r\n", d->character);
    return;
  }
}
...
void zedit_disp_arg2(struct descriptor_data *d)
{
  ...
  default:
     ...
     */
    cleanup_olc(d, CLEANUP_ALL);
    mudlog("SYSERR: OLC: zedit_disp_arg2(): Help!", BRF, LVL_IMMORT, TRUE);
    send_to_char("Oops...\r\n", d->character);
    return;
  }
...
/*-------------------------------------------------------------------*/
  case ZEDIT_ARG1:
    ...
    default:
       ...
       */
      cleanup_olc(d, CLEANUP_ALL);
      mudlog("SYSERR: OLC: zedit_parse(): case ARG1: Ack!", BRF, LVL_IMMORT, TRUE);
      send_to_char("Oops...\r\n", d->character);
      break;
    }
    break;
